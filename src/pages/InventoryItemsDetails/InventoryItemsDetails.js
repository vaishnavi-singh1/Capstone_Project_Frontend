...
function InventoryItemsDetails() {
  ...
  let inventoryURL = `http://localhost:9000/inventories/${itemID}`;
    ...
    <div className="page-body">
      <header className="inventory-header">
        <h1 className="inventory-header__itemName">
          <Link to={`/godowns/${currentItem.godownID}`}>
      ...
      <section className="inventory-body">
        ...
        <div className="inventory-container-status-quantity-godown">
          ...
          <div>
            ...
            <p className="info-details">{currentItem.godownName}</p>
          </div>
        </div>
      </section>
    </div>
